...
function Listar(){
    ...
    for(var i in tbClientes){
        ...
        $("#tblListar tbody").append("<td><img src='imagens/editar.png' alt='"+i+"'class='btnEditar'/><img src='imagens/excluir.png' alt='"+i+"' class='btnExcluir'/></td>");
